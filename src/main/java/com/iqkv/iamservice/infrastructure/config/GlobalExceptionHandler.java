...
import com.iqkv.iamservice.infrastructure.messaging.MessagingException;
import com.iqkv.iamservice.shared.exception.AccountLockedException;
import com.iqkv.iamservice.shared.exception.InvalidTenantStateException;
import com.iqkv.iamservice.shared.exception.InvalidTokenSignatureException;
import com.iqkv.iamservice.shared.exception.InvalidTokenTypeException;
import com.iqkv.iamservice.shared.exception.InvalidVerificationTokenException;
import com.iqkv.iamservice.shared.exception.MembershipNotFoundException;
import com.iqkv.iamservice.shared.exception.PasswordResetRateLimitException;
import com.iqkv.iamservice.shared.exception.PasswordResetTokenNotFoundException;
import com.iqkv.iamservice.shared.exception.SchemaProvisioningException;
import com.iqkv.iamservice.shared.exception.TenantAlreadyExistsException;
import com.iqkv.iamservice.shared.exception.TenantContextMismatchException;
import com.iqkv.iamservice.shared.exception.TenantManagementException;
import com.iqkv.iamservice.shared.exception.TenantMembershipAlreadyExistsException;
import com.iqkv.iamservice.shared.exception.TenantNotAvailableException;
import com.iqkv.iamservice.shared.exception.TenantNotFoundException;
import com.iqkv.iamservice.shared.exception.TenantSuspendedException;
import com.iqkv.iamservice.shared.exception.TokenExpiredException;
import com.iqkv.iamservice.shared.exception.UserManagementException;
import com.iqkv.iamservice.shared.exception.UserNotFoundException;
import com.iqkv.iamservice.shared.exception.UserRegistrationException;
import com.iqkv.iamservice.shared.exception.VerificationRateLimitException;
