...
package com.iqkv.iamservice.authentication;
...
import com.iqkv.iamservice.denylist.TokenDenylistService;
import com.iqkv.iamservice.email.EmailVerificationToken;
import com.iqkv.iamservice.email.EmailVerificationTokenMapper;
import com.iqkv.iamservice.infrastructure.config.NotificationConfigurationProperties;
import com.iqkv.iamservice.infrastructure.messaging.MessagingService;
import com.iqkv.iamservice.infrastructure.messaging.NotificationEvent;
import com.iqkv.iamservice.infrastructure.messaging.NotificationEventType;
import com.iqkv.iamservice.lockout.AccountLockoutManager;
import com.iqkv.iamservice.membership.MembershipService;
import com.iqkv.iamservice.membership.TenantMembership;
import com.iqkv.iamservice.membership.TenantMembershipMapper;
...
import com.iqkv.iamservice.tenant.Tenant;
import com.iqkv.iamservice.tenant.TenantMapper;
import com.iqkv.iamservice.tenant.TenantStatus;
import com.iqkv.iamservice.tenancy.TenantContext;
import com.iqkv.iamservice.user.UserMapper;
...
public class AuthenticationServiceImpl implements AuthenticationService {
  ...
  public AuthenticationDtos.TokenResponse refresh(final AuthenticationDtos.RefreshTokenRequest request) {
    ...
    if (!JwtClaimNames.TYPE_REFRESH.equals(type)) {
      throw new com.iqkv.iamservice.shared.exception.InvalidTokenTypeException();
    }
  ...
  public List<AuthenticationDtos.TenantMembershipSummary> listUserTenants(
    ...
    for (final TenantMembership membership : memberships) {
      if (membership.getStatus() != com.iqkv.iamservice.membership.MembershipStatus.ACTIVE) {
        continue;
      }
