...
/**
 * IAM-service implementation of {@link TenantKeyProvider}.
 *
...
public class AllTenantsKeyProvider implements TenantKeyProvider {
  ...
  public AllTenantsKeyProvider(final TenantMapper tenantMapper) {
    this.tenantMapper = tenantMapper;
  }

  @Override
  public List<String> findAllTenantKeys() {
    final List<String> keys = tenantMapper.findAllTenantKeysForUpgrade();
