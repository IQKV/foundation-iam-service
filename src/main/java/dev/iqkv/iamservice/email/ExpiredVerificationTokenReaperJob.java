...
package dev.iqkv.iamservice.email;
...
public class ExpiredVerificationTokenReaperJob {
  ...
  private static final Logger log = LoggerFactory.getLogger(ExpiredVerificationTokenReaperJob.class);

  private final EmailVerificationTokenMapper emailVerificationTokenMapper;

  public ExpiredVerificationTokenReaperJob(final EmailVerificationTokenMapper emailVerificationTokenMapper) {
