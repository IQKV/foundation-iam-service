...
import dev.iqkv.iamservice.infrastructure.messaging.MessagingException;
import dev.iqkv.iamservice.shared.exception.AccountLockedException;
import dev.iqkv.iamservice.shared.exception.InvalidTenantStateException;
import dev.iqkv.iamservice.shared.exception.InvalidTokenSignatureException;
import dev.iqkv.iamservice.shared.exception.InvalidTokenTypeException;
...
import dev.iqkv.iamservice.shared.exception.PasswordResetRateLimitException;
import dev.iqkv.iamservice.shared.exception.PasswordResetTokenNotFoundException;
import dev.iqkv.iamservice.shared.exception.SchemaProvisioningException;
import dev.iqkv.iamservice.shared.exception.TenantAlreadyExistsException;
import dev.iqkv.iamservice.shared.exception.TenantContextMismatchException;
import dev.iqkv.iamservice.shared.exception.TenantManagementException;
import dev.iqkv.iamservice.shared.exception.TenantMembershipAlreadyExistsException;
import dev.iqkv.iamservice.shared.exception.TenantNotAvailableException;
import dev.iqkv.iamservice.shared.exception.TenantNotFoundException;
import dev.iqkv.iamservice.shared.exception.TenantSuspendedException;
import dev.iqkv.iamservice.shared.exception.TokenExpiredException;
import dev.iqkv.iamservice.shared.exception.UserManagementException;
import dev.iqkv.iamservice.shared.exception.UserNotFoundException;
import dev.iqkv.iamservice.shared.exception.UserRegistrationException;
